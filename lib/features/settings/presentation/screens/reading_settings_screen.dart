...
// Book reading parameters: font, night mode, tap-highlight, translation
// text styling, page-swipe direction - everything that affects the reader
// screen itself, as opposed to LanguageSettingsScreen's app/goal language
// and offline pack management.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(l10n.readingFolderTitle),
      ),
      body: BlocBuilder<SettingsCubit, ReaderSettings>(
        ...
        builder: (context, settings) {
          return Column(
            ...
            children: [
              _SectionLabel(l10n.textSizeLabel, colors),
              Row(
                children: [
                  Text(l10n.letterA, style: TextStyle(fontSize: 14, color: colors.textSecondary)),
                  Expanded(
                    child: Slider(
                  ...
                  Text(l10n.letterA, style: TextStyle(fontSize: 24, color: colors.textSecondary)),
                ],
              ),
              const SizedBox(height: 12),
              _SectionLabel(l10n.fontLabel, colors),
              ...
              SwitchListTile(
                contentPadding: EdgeInsets.zero,
                title: Text(l10n.highlightTappedWordsLabel, style: TextStyle(color: colors.textPrimary)),
              ...
              const SizedBox(height: 20),
              _SectionLabel(l10n.translationTextLabel, colors),
              Row(
                children: [
                  Text(l10n.sizeLabel, style: TextStyle(color: colors.textSecondary)),
                  Expanded(
                    child: Slider(
